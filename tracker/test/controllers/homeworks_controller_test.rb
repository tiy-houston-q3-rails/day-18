...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { assignment: @homework.assignment, day: @homework.day, grade: @homework.grade, icon: @homework.icon, on_time: @homework.on_time }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { assignment: @homework.assignment, day: @homework.day, grade: @homework.grade, icon: @homework.icon, on_time: @homework.on_time }
    assert_redirected_to homework_path(assigns(:homework))
  end
